...
const orderModifier = (order) => {
  ...
  console.log(
    `Olá ${order.order.delivery.deliveryPerson}, o total do seu pedido de ${order.order.pizza.marguerita.name}, ${order.order.pizza.pepperoni.name}, ${order.order.drinks.coke.type} é R$ ${order.payment.total},00`
  );
};
